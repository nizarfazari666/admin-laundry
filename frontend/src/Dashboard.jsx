        ...
        <table style={styles.mainTableStructure}>
          <thead>
            <tr style={styles.tableHeaderRow}>
              ...
              <th style={{...styles.tableHeaderCell, width: '15%'}}>TOTAL (Rp)</th>
              <th style={{...styles.tableHeaderCell, textAlign: 'center', width: '15%'}}>STATUS</th>
              <th style={{...styles.tableHeaderCell, textAlign: 'center', width: '25%'}}>AKSI</th>
            </tr>
          </thead>
          <tbody>
            {transaksi.length === 0 ? (
              ...
              transaksi.map((t) => (
                <tr key={t.id_transaksi} style={styles.tableBodyRow}>
                  ...
                  <td style={{...styles.tableBodyCell, textAlign: 'center'}}>
                  ...
                  <td style={styles.actionButtonContainer}>
                    <button onClick={() => handleEdit(t)} style={styles.actionBtnEdit}>EDITS</button>
                    <button onClick={() => handleDelete(t.id_transaksi)} style={styles.actionBtnDelete}>DELETE</button>
                    <button onClick={() => handleCetak(t)} style={styles.actionBtnPrint}>INVOICE</button>
                  </td>
                </tr>
              ))
            )}
